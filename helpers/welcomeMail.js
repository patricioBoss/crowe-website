export default function welcomeMail(name = "", loginLink) {
  ...
  <html lang="en" dir="ltr">
      <head>
          <meta charset="UTF-8" />
          <title>Welcome to Angela Crowe Wealth Management</title>
          <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
          <meta content="Angela Crowe Wealth Management" name="description" />
          <meta name="author" content="Angela Crowe Wealth Management" />
              ...
              <table cellpadding="0" cellspacing="0" style="font-family: Nunito, sans-serif; font-size: 15px; font-weight: 400; max-width: 600px; border: none; margin: 0 auto; overflow: hidden; background-color: #fff; box-shadow: 0 0 3px rgba(60, 72, 88, 0.15);">
                  <thead>
                      <tr style="background-color: #14609a; padding: 3px 0; border: none; line-height: 68px; text-align: center; color: #fff; font-size: 24px; letter-spacing: 1px;">
                          <th scope="col"><img style="width: 300px; margin-top: 50px;" src="https://pipsville-bucket.s3.us-west-004.backblazeb2.com/Angela+Crowe.png" alt=""></th>
                      </tr>
                  </thead>
                  ...
                  <tbody>
                      <tr>
                          <td style="padding: 48px 24px 0; color: #161c2d; font-size: 18px; font-weight: 600;">
                              Welcome to Angela Crowe Wealth Management, ${name}
                          </td>
                      </tr>
                      <tr>
                          <td style="padding: 15px 24px 15px; color: #676d74;">
                              Thanks for creating an account with Angela Crowe Wealth Management. To continue, please login and perform the needed verification by submitting a valid I.D
                          </td>
                      </tr>
                      ...
                      <tr>
                          <td style="padding: 15px 24px 15px; color: #676d74;">
                              Angela Crowe Wealth Management <br> Support Team
                          </td>
                      </tr>
      
                      <tr>
                          <td style="padding: 16px 8px; color: #676d74; background-color: #f8f9fc; text-align: center;">
                              © <script>document.write(new Date().getFullYear())</script> Angela Crowe Wealth Management.
                          </td>
                      </tr>
                  </tbody>
              </table>
